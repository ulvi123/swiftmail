                ...
                <div className="text-center space-y-8">
                    ...
                    <div className="inline-flex items-center px-4 py-2 rounded-full
                        ...
                        <span className="text-sm font-medium bg-gradient-to-r from-gray-800 to-gray-600 
                            ...
                            Powered by Claude sonnet,model-01
                        </span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
                        <button className="group relative px-8 py-4 rounded-xl text-white
                        ...
                        <button className="group px-8 py-4 rounded-xl text-lg font-medium
